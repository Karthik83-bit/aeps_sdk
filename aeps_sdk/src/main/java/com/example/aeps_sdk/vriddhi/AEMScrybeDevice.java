...
public class AEMScrybeDevice {
    ...
    public com.example.aeps_sdk.vriddhi.CardReader getCardReader(com.example.aeps_sdk.vriddhi.IAemCardScanner readerImpl)
    {
        if (bluetoothSocket == null)
            return null;

        return new com.example.aeps_sdk.vriddhi.CardReader(bluetoothSocket, readerImpl);
    }

    public com.example.aeps_sdk.vriddhi.AEMPrinter getAemPrinter()
    {
        if (bluetoothSocket == null)
            return null;

        return new com.example.aeps_sdk.vriddhi.AEMPrinter(bluetoothSocket);
    }
