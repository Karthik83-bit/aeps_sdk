...
//
    ...
    public void printImage(Bitmap resizedBitmap) {
        com.example.aeps_sdk.vriddhi.PrintRasterImage PrintRasterImage = new com.example.aeps_sdk.vriddhi.PrintRasterImage(getResizedBitmap(resizedBitmap));
        PrintRasterImage.PrepareImage(com.example.aeps_sdk.vriddhi.PrintRasterImage.dither.floyd_steinberg, 128);
